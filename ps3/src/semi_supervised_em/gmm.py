...
def main(is_semi_supervised, trial_num):
    ...
    if is_semi_supervised:
        w, phi, mu, sigma = run_semi_supervised_em(x, x_tilde, z_tilde, w, phi, mu, sigma)
    else:
        w, phi, mu, sigma = run_em(x, w, phi, mu, sigma)
    ...
    plot_gmm_preds(x, z_pred, is_semi_supervised, plot_id=trial_num, mu=mu, sigma=sigma, phi=phi)
...
#     y = 2 + 3* np.sin(x)
#     plt.scatter(x, y)
#     ellipse = matplotlib.patches.Ellipse([3, 2], 0.6, 3, angle=10, color='green', fill=False)
#     ellipse2 = matplotlib.patches.Ellipse([3, 2], 0.6, 3, angle=0, color='red', fill=False)
#     ellipse3 = matplotlib.patches.Ellipse([3, 2], 0.6, 3, angle=-45, color='yellow', fill=False)
#     plt.grid()
#     ax.add_patch(ellipse)
